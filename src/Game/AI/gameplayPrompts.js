...
12. Every storylineUpdates, warUpdates, relationUpdates, agreementUpdates and institutionUpdates entry must reference at least one real transaction event through eventIndexes. Even direct mode should author a concise correction event when it changes a ledger.
...
15. institutionUpdates controls formal organization/bloc membership and leadership. Membership is canonical state, not a descriptive tag: joining/leaving/suspension/role changes require the matching structured operation.
...
institutionUpdatesJson element:
{"id":"stable-institution-id","op":"create|join|leave|suspend|restore|role|dissolve","polity":"Full Polity Name","status":"member|candidate|associate|observer|suspended","role":"leader|leading-member|member","eventIndexes":[0],"name":"","kind":"security_alliance|defense_pact|political_union|economic_union|regional_bloc|international_organization|consultative_group|other","note":""}
For create/dissolve, polity may be blank. For create include name/kind. Formal membership wins over fuzzy alignment tags.
